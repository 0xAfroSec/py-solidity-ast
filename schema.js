...
const nullable = (schema) =>
  schema ? optional(anyOf(schema, _null)) : optional(_null);
...
const yulNode = (type, props) =>
  object({ ...baseYulNode, ...props, nodeType: literal(type) });
...
const schema = {
  ...
  definitions: {
    ...
    StorageLocation: literal("calldata", "default", "memory", "storage"),
    ...
    ...nodes({
      ...
      DoWhileStatement: {
        ...baseStatement,
        body: anyOf(ref("Block"), ref("Statement")),
        condition: ref("Expression"),
      },
      ...
      ForStatement: {
        ...
        initializationExpression: nullable(
          anyOf(ref("ExpressionStatement"), ref("VariableDeclarationStatement"))
        ),
      ...
      IfStatement: {
        ...baseStatement,
        condition: ref("Expression"),
        falseBody: nullable(anyOf(ref("Statement"), ref("Block"))),
        trueBody: anyOf(ref("Statement"), ref("Block")),
      },
      ...
      InheritanceSpecifier: {
        ...
        baseName: anyOf(ref("UserDefinedTypeName"), ref("IdentifierPath")),
      },
      ...
      Literal: {
        ...
        kind: literal("bool", "number", "string", "hexString", "unicodeString"),
      ...
      ModifierInvocation: {
        arguments: nullable(array(ref("Expression"))),
        kind: optional(
          literal("modifierInvocation", "baseConstructorSpecifier")
        ),
        modifierName: anyOf(ref("Identifier"), ref("IdentifierPath")),
      },
      ...
      UsingForDirective: {
        ...
        libraryName: optional(
          anyOf(ref("UserDefinedTypeName"), ref("IdentifierPath"))
        ),
    ...
    YulLiteral: anyOf(ref("YulLiteralValue"), ref("YulLiteralHexValue")),
    ...
    ...yulNodes({
      ...
      YulCase: {
        body: ref("YulBlock"),
        value: anyOf(literal("default"), ref("YulLiteral")),
      },
